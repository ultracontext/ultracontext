...
**UltraContext is the context API for AI agents.**

It's the simplest way to control what your agents see. Replace messages, compact/offload long context, replay decisions and roll back mistakes with a single API call. Versioned context out of the box. Full history. Zero complexity.
...
UltraContext gives you primitives for all of these. See the [guides](/guides/store-retrieve-contexts) for patterns.
...
UltraContext consists of **Contexts** holding **Messages**. That's it. Simple yet insanely powerful. Let's dive in.
